...
export default function ExperienceImage({
  ...
  return (
    <div
      onClick={handleClick}
      className={`inline-block bg-[#1F1F1F] rounded-lg relative overflow-hidden cursor-pointer group border border-[#282828] hover:-translate-y-[2px] transition-all duration-300 ${
        isMobile ? "w-[160px] h-[320px]" : "w-[300px] h-[150px]"
      }`}
    >
      <Image
        src={imageUrl}
        width={isMobile ? 160 : 300}
        height={isMobile ? 320 : 150}
        alt="pantallazo"
